          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: const [
                  DevImage(name: "Tarek Allam", imagePath: "img/tarek.jpeg"),
                  DevImage(name: "Nada Moussa", imagePath: "img/nada.jpeg"),
                ],
              ),
              const SizedBox(height: 10),
              Row(
                ...
                children: const [
                  DevImage(
                      name: "Mona Elsha3er", imagePath: "img/elshaer.jpeg"),
                  DevImage(name: "Mona Elsa3ed", imagePath: "img/mona.jpeg"),
                ],
              ),
              const SizedBox(height: 10),
            ],
